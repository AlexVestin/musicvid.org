...
export default class Manager {
    ...
    setUpScene = () => {
        ...
        //const it2 = this.scenes[0].addItemFromText("Background");

        //const it1 = this.scenes[0].addItemFromText("TimeRepCanvas");
        const it2 = this.scenes[1].addItemFromText("LineBed");
