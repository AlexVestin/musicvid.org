...
export default class JSNationSpectrum extends BaseItem {
    ...
    __setUpGUI = (folder) => {
        this.canvasSettings = addCanvasControls(this, this.ctx, folder, {
            text: false
        });
        ...
        this.addController(emFolder, this.emblem, "alpha", {
            path: "emblem",
            min: 0,
            max: 1
        });
        ...
        this.addController(moveFolder, this, "returnSpeed", {
            min: 0,
            max: 10
        });
        this.addController(moveFolder, this, "displacementThreshold", {
            min: 0,
            max: 10
        });
        ...
        this.addController(spFolder, this, "clipOffset", {
            min: 0.0,
            max: 200,
            step: 1
        });
        ...
        this.addController(spFolder, this, "startBin", {
            min: 0,
            max: 1000,
            step: 1
        });
        this.addController(spFolder, this, "keepBins", {
            min: 1,
            max: 1000,
            step: 1
        });
        this.addController(spFolder, this, "smoothingPasses", {
            values: [1, 2, 3, 4, 5, 6, 7, 8, 9]
        });
        this.addController(spFolder, this, "smoothingPoints", {
            values: [1, 2, 3, 4, 5, 6, 7, 8, 9]
        });
        this.addController(spFolder, this, "spectrumHeightScalar", {
            min: 0,
            max: 1.0
        });
        this.addController(spFolder, this, "smoothingTimeConstant", {
            min: 0,
            max: 0.95
        });
    ...
    update = (time, dt, audioData, shouldUpdate = true) => {
        ...
        if (newAudioData && shouldUpdate) {
            ...
            const subSpectrum = audioData.frequencyData.slice(
                this.startBin,
                this.startBin + this.keepBins
            );
            const dbfs = toWebAudioForm(
                subSpectrum,
                this.prevArr,
