...
const perspectiveItems = {
    Particles: {
        authors: "@Caseif & @Incept",
        url: "https://github.com/caseif/js.nation",
        class: Particles,
        img: "img/items/Particles.png"
    },
    LineBed: {
        authors: "GamleGaz",
        class: LineBed,
        img: "img/items/LineBEd.png"
    },
    ParticlesSideways: {
        url: "https://github.com/caseif/vis.js",
        authors: "@Caseif & @Incept",
        class: ParticlesSideways,
        img: "img/items/ParticlesSideways.png"
    },
...
const canvasItems = {
    ...
    Polartone2D: {
        class: Polartone2D,
        img: "img/items/Polartone.png",
        url: "https://github.com/mattdesl/Polartone",
        authors: "Mattdesl"
    },
    BeatCounter: { class: BeatCounter },
    JSNation: {
        img: "img/items/JSNation.png",
        authors: "@Caseif & @Incept",
        class: JSNation2D
    },
    JSNation2: {
...
const orthoItems = {
    ...
    TimeRep: {
        authors: "GamleGaz",
        class: TimeRep,
        img: "img/items/AudioWaveItem.png"
    },
...
if (licensed) {
    const licensedOrthoItems = [
        ...
        {
            path: "./ortho/HexaGone.js",
            img: "img/items/HexaGone.png",
            url: "https://www.shadertoy.com/view/wsl3WB",
            authors: "BigWIngs",
            name: "HexaGone"
        },
        {
            path: "./ortho/UniverseWithin.js",
            img: "img/items/UniverseWithin.png",
...
export default function getItemClassFromText(type, name) {
    if (name === "Noise") {
        setSnackbarMessage(
            "Electric Noise item has been removed.",
            "error",
            10000
        );
        return null;
