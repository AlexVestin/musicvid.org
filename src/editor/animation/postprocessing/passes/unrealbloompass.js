...
export default class UnrealBloomPass extends Pass {
    constructor(resolution, strength, radius, threshold) {
        ...
        for (var i = 0; i < this.nMips; i++) {
            var renderTargetHorizonal = new THREE.WebGLRenderTarget(
                resx,
                resy,
                pars
            );
            ...
            var renderTargetVertical = new THREE.WebGLRenderTarget(
                resx,
                resy,
                pars
            );
    ...
    __setUpGUI = folder => {
        this.addController(folder,this, "strength", {path: "bloom", min: 0, max: 5}).name("Bloom strength");
