...
var WasmEncoder = (function () {
    ...
    return function (WasmEncoder) {
        ...
        var STACK_BASE = 6576672,
            STACKTOP = STACK_BASE,
            STACK_MAX = 1333792,
            DYNAMIC_BASE = 6576672,
            DYNAMICTOP_PTR = 1332864;
        if (ENVIRONMENT_IS_PTHREAD) {
        }
        ...
        var wasmBinaryFile = "WasmEncoder1t.wasm";
        ...
        var __main_thread_futex_wait_address = 1333776;
        ...
        var PThread = {
            ...
            initMainThreadBlock: function () {
                PThread.mainThreadBlock = 1333024;
        ...
        var ___tm_timezone = (stringToUTF8("GMT", 1332928, 4), 1332928);
        ...
        var asmLibraryArg = {
            ...
            r: _emscripten_set_current_thread_status,
        ...
        var _free = (Module["_free"] = function () {
            return (_free = Module["_free"] = Module["asm"]["ca"]).apply(
                null,
                arguments
            );
        });
