...
var Module = typeof MallocTest !== 'undefined' ? MallocTest : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_test_malloc')) {
        Object.defineProperty(Module['ready'], '_test_malloc', { configurable: true, get: function() { abort('You are getting _test_malloc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_test_malloc', { configurable: true, set: function() { abort('You are setting _test_malloc on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile = 'malloc.wasm';
...
/** @type {function(...*):?} */
var _test_malloc = Module["_test_malloc"] = createExportWrapper("test_malloc");
...
// {{MODULE_ADDITIONS}}
  ...
  return MallocTest.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
      module.exports = MallocTest;
    else if (typeof define === 'function' && define['amd'])
      define([], function() { return MallocTest; });
    else if (typeof exports === 'object')
      exports["MallocTest"] = MallocTest;
